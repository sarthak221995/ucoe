...
class Post(models.Model):
	YEAR_CHOICES = (('FIRSTSEMESTER','FIRST_SEMESTER'),('SECONDSEMESTER','SECOND_SEMESTER'),('THIRDSEMESTER','THIRD_SEMESTER'),('FOURTHSEMESTER','FOURTH_SEMESTER'),('FIFTHSEMESTER','FIFTH_SEMESTER'),('SIXTHSEMESTER','SIXTH_SEMESTER'),('SEVENTHSEMESTER','SEVENTH_SEMESTER'),('EIGHTSEMESTER','EIGHT_SEMESTER'),('MTECH','MTECH'))
